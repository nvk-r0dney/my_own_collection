...
short_description: This is my test module for new file creation

# If this is part of a collection, you need to use semantic versioning,
# i.e. the version is of the form "2.5.0" and not "2.4".
version_added: "1.0.0"

description: Module creates file with some content

options:
    path:
        description: This is a path to the new file
        required: true
        type: str

    content:
        description: This is a content to the new file
        required: false
        type: str
        default: Hello, World!
...
def run_module():
    ...
    and open(module.params['path'], 'r').read() == module.params['content']):
        try:
            ...
            module.fail_json(msg=f"Something wrong: {exp}", **result)
